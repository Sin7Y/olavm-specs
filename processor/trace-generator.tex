...
\begin{table}[!ht]
    \centering \resizebox{0.8\linewidth}{!}{
        \begin{tabular}{*{6}{|c}|}
            \hline
            cpu\_filter & memory\_filter & cmp\_filter  & value & limb\_lo & limb\_hi     \\ \hline
        \end{tabular}}
...
\begin{table}[!ht]
    \centering \resizebox{\linewidth}{!}{
        \begin{tabular}{*{10}{|c}|}
            \hline
            tag & op1\_value & op2\_value & res\_value &  op1\_0 & op1\_1 & op1\_2 & op1\_3 & op2\_0 & op2\_1 \\ \hline
            op2\_2 & op2\_3 & res\_0 & res\_1 & res\_2 & res\_3 &  &  &  &    \\ \hline
        \end{tabular}}
...
\begin{table}[!ht]
    \centering \resizebox{\linewidth}{!}{
        \begin{tabular}{*{6}{|c}|}
            \hline
            op1 value & op2 value & diff & diff\_lo & diff\_hi & filter\_looked\_for\_range\_check   \\ \hline
        \end{tabular}}
